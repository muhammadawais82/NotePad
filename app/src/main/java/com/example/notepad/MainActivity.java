...
import static com.example.notepad.edite_note.NOTE_EXTRA_Key;
...
public class MainActivity extends AppCompatActivity implements NoteEventListener, Drawer.OnDrawerItemClickListener {
    ...
    private void onAddNewNote() {
        startActivity(new Intent(this, edite_note.class));
    ...
    public void onNoteClick(Note note) {
        Intent edit = new Intent(this, edite_note.class);
